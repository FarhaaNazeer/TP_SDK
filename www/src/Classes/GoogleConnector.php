...
class GoogleConnector extends AuthConnectorFactory
{
    private $url;
    private $client_id;
    ...
    {
        return new GoogleAuth($this->url, $this->client_id, $this->redirect_uri, $this->scope, $this->access_type, $this->response_type);
    }
}
